...
const WebScroll = () => {
  ...
  useEffect(() => {
    ...
    const framesDir = "/images/smellbetter/web";
  ...
  return (
    <section className="py-20 md:py-0 bg-gradient-to-tl from-[#CE6039] to-[#F37F55]">
          ...
          <div className="md:sticky top-0 md:h-screen min-h-fit lg:w-[350px] mx-auto">
            <div className="flex flex-col justify-center md:h-screen">
              <h2 className="mb-4">
                ...
                <br />
                <span className="h2">What does your website smell like?</span>
              </h2>
              <p>
                After a successful rebranding, refreshing the SmellBetter
                Hawai’i marketing website allowed us to think on a more
                experiential canvas. We created some wavy animations with a
                custom set of icons and imagery for their scents & services for
                you to smell through your browser.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="md:hidden px-4">
        <div className="flex flex-col justify-center md:h-screen gap-8">
          ...
          <p className="w-10/12">
            After a swimmingly successful rebranding, refreshing the SmellBetter
            Hawai’i marketing website allowed us to think on a more experiential
            canvas. We created some wavy animations with a custom set of icons
            and imagery for their scents & services for you to smell through
            your browser.
          </p>
          <StaticImage
            placeholder="blurred"
