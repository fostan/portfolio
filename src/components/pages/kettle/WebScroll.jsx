...
const WebScroll = () => {
  ...
  useEffect(() => {
    ...
    const framesDir = "/images/kettle/web";
    ...
    <section className="py-20 md:py-0 bg-gradient-to-tl from-[#F9D055] to-[#FDD53F]">
          ...
          <div className="md:sticky top-0 md:h-screen min-h-fit lg:w-[350px] mx-auto">
            <div className="flex flex-col justify-center md:h-screen">
              <h2 className="mb-4">
                ...
                <br />
                <span className="h2">Out for a scroll</span>
              </h2>
              <p>
                Close communication with both designers and animators allowed us
                to create a variety of page based animations triggered by the
                user's scroll position. Included is a small demo showing
                Kettle’s impressive wildfire prediction from 2020.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="md:hidden px-4">
        <div className="flex flex-col justify-center md:h-screen gap-8">
          ...
          <p className="w-10/12">
            Close communication with both designers and animators allowed us to
            create a variety of page based animations triggered by the user's
            scroll position. Included is a small demo showing Kettle’s
